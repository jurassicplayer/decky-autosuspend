...
export class SteamCssVariables {
  ...
  static gpGradientStoreBackground      = "var(--gpGradient-StoreBackground,    linear-gradient(180deg, var(--gpStoreDarkGrey,#2A475E) 0%, var(--gpStoreDarkerGrey,#1B2838) 80%))"
  static gpGradientLibraryBackground    = "var(--gpGradient-LibraryBackground,  radial-gradient(farthest-corner at 40px 40px, var(--gpSystemDarkGrey, #3D4450) 0%, var(--gpSystemDarkerGrey, #23262E) 80%))"
  ...
  static gpWidth6colcap       = "var(--gpWidth-6colcap, calc((var(--screen-width, 100vw) - (5 * var(--gpSpace-Gap, 12px)) - (2 * var(--gpSpace-Gutter, 24px))) / 6))"
  static gpWidth5colcap       = "var(--gpWidth-5colcap, calc((var(--screen-width, 100vw) - (4 * var(--gpSpace-Gap, 12px)) - (2 * var(--gpSpace-Gutter, 24px))) / 5))"
  static gpWidth4colcap       = "var(--gpWidth-4colcap, calc((var(--screen-width, 100vw) - (3 * var(--gpSpace-Gap, 12px)) - (2 * var(--gpSpace-Gutter, 24px))) / 4))"
  static gpWidth3colcap       = "var(--gpWidth-3colcap, calc((var(--screen-width, 100vw) - (2 * var(--gpSpace-Gap, 12px)) - (2 * var(--gpSpace-Gutter, 24px))) / 3))"
  static gpWidth2colcap       = "var(--gpWidth-2colcap, calc((var(--screen-width, 100vw) - (1 * var(--gpSpace-Gap, 12px)) - (2 * var(--gpSpace-Gutter, 24px))) / 2))"
  static gpWidth1colcap       = "var(--gpWidth-1colcap, calc((var(--screen-width, 100vw) - (2 * var(--gpSpace-Gutter, 24px)))))"
