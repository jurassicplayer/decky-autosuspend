    ...
    <div style={SteamCss.NotificationPrefDetails}>
      ...
      <div>
        <DropdownItem
          ...
          disabled={enabled}
          label={<span>Threshold Level:<span style={descriptionCss}>Type of threshold to trigger alarm</span></span>}
          bottomSeparator="none"
          strDefaultLabel="Error"
          focusable={!enabled}/>
      </div>
      ...
      {/* <div style={{display: "flex", flexDirection: "column"}}> */}
        ...
        <DialogButton
          ...
          onOKButton={()=>{SteamUtils.notify(alarmName, alarmMessage, showToast, playSound, sound)}}>Test</DialogButton>
      {/* </div> */}
